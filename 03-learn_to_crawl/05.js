...
console.log(saludo + " " +friend);
console.log(`${saludo} ${friend}`);
console.log(`${saludo} ${familiar}`);
console.log(saludo + " " + familiar);
console.log(`${saludo} ${friend}! Hoy es ${day} de ${month}`);
console.log(`Hoy, ${day} de ${month} de ${year}, estoy cumpliendo ${year - 1974}`);
