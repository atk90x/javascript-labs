...
let n1 = 3456, n2 = 55342, n3 = 3956;
let luckyNumber = 7;

let uno = (n1+n2+n3+luckyNumber);
let dos = (n2-(n1+n3));
let tres = (n1*n2*n3*luckyNumber);
let cuatro = (n2 / (n3-n1));
let cinco = (n1 % luckyNumber);
let seis = (n2 % luckyNumber);
let siete = (n3 % luckyNumber);

let result2 = 0;
console.log("Primero", uno);
console.log("Segundo", dos);
console.log("Tercero", tres);
console.log("Cuarto", cuatro);
console.log("Cuarto", cuatro);
console.log("Quinto", cinco);
console.log("Septimo", siete);
